...
{
    public class HandCarManagerController : Controller
    {
        private int PageSize = 6;
        private YuanChen.BLL.News NewsBll = new YuanChen.BLL.News();
        private HandCarService service = new HandCarService();

        //
        // GET: /Admin/HandCarManager/
        /// <summary>
        /// 二手车交易、评估
        /// </summary>
        ...
        public ActionResult Add(ManagerModel model, FormCollection fc)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                newinfo.TypeID = new Guid("5C0DE674-C29F-4FDC-86E2-9C36CC98F9DE");
                //保存到数据库News
